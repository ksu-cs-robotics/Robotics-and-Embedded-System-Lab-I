...
##########################################################################
#   Instructional Note:  
#		This code is for Python 3X. If you are using Python 2.x, use "Serial2Bluetooth-Fowarder.py
...
sUSB = serial.Serial('COM4', 9600) # Establish the connection on a specific port
sBluetooth = serial.Serial('COM5', 9600) # Establish the connection on a specific port
